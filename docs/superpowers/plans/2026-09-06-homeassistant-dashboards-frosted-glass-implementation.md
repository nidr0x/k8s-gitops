...
- [x] **Step 1: Enumerate the current dashboard metadata.**
...
- [x] **Step 2: Read every source dashboard fresh.**
...
- [x] **Step 3: Inventory resources and the actual Frosted Glass theme.**
...
- [x] **Step 4: Read the states used by the redesign.**
...
- [x] **Step 5: Validate the preflight evidence.**
...
- [x] **Step 1: Assemble the configuration from verified entities.**
...
- [x] **Step 2: Create the dashboard through the API.**
...
- [x] **Step 3: Read the new dashboard back.**
...
- [x] **Step 4: Render `Inicio` in both target sizes.**
...
- [x] **Step 1: Select source cards without inventing replacements.**
...
- [x] **Step 2: Build the four `sistema` views.**
...
- [x] **Step 3: Create and structurally verify the dashboard.**
...
- [x] **Step 4: Render the consolidated system views.**
...
- [x] **Step 1: Transform `casa` without losing room routes.**
...
- [x] **Step 2: Transform `coche` from verified Kitt and Wall Connector cards.**
...
- [x] **Step 3: Transform `energia` while preserving Helios.**
...
- [x] **Step 4: Render all three dashboards.**
...
- [x] **Step 1: Re-read all nine dashboard metadata records.**
...
- [x] **Step 2: Hide only the superseded dashboards.**
...
- [x] **Step 3: Verify sidebar count and navigation links.**
...
- [x] **Step 1: Re-read the final live state.**
...
- [x] **Step 2: Check entity and route preservation.**
...
- [x] **Step 4: Retain rollback state.**
...
- [x] **Step 5: Finish the coordination boundary.**
